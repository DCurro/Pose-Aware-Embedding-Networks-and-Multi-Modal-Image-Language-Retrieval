...
from nets.net_vgg_fc7 import cpu_net
...
if __name__ == '__main__':
    ...
    pretrained_weights = PathManager.path_vggs_weights
    model_data = torch.load(pretrained_weights)
    ...
    val_loader = torch.utils.data.DataLoader(dataset_val, num_workers=6, shuffle=False, batch_size=111)
    embed('valtest')
