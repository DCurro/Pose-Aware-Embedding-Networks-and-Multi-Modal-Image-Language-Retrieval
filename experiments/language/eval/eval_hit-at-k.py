...
gt_distances = np.load(PathManager.path_distance_frame0_path_hamming_valtest) * 100.0
nearfarsplit = np.load(PathManager.path_nearfarsplit_frame0_path_hamming_val)
nearfarsplit = np.repeat(nearfarsplit, 10).reshape((nearfarsplit.shape[0],10))
